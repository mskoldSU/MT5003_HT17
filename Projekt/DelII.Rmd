...
Verifiera att utskriftens `z value`-kolumn är Wald-statistikor, d.v.s. lärobokens (4.12), med hjälp av funktionerna `I` och `NR` från Del I.
...
profil$coeff
```
som ger ML-skattningar hos övriga koefficienter då $\theta_{Kon}=0.5$ (som ett exempelvärde). Bestäm ett 95%-igt konfidensintervall baserat på profil-likelihooden visuellt ur figuren (jfr Figur 5.3b i läroboken) och jämför med motsvarande Wald-intervall.
