...
<div class="columns-2">
```{r, out.width = "200px"}
knitr::include_graphics("GeorgeEPBox.jpg")
```
<div class="white">
...
Score-funktionen till en deriverbar likelihood-funktion $L$ av en variabel $\theta$ är log-likeliehoodfunktionens derivata
$$
